...
> **Canonical:** `workflows/create-workflow/create-workflow.md` (in this repo). This file is a thin pointer for Cursor skill discovery — load the canonical workflow doc for the full methodology.
